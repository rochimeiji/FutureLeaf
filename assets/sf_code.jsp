...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.14.55";
...
superfish.b.supportedBy="Snap.do";
superfish.b.shareMsgProd='Snap.do';
...
superfish.b.psuSupportedByText='Snap.do';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='Snap.do';
superfish.b.cpn='0';
...
//        if ( this.bl.indexOf('|'+ this.domain + '|') == -1 ) {
            ...
            if ( o == 'us' || o == 'au' || (o == 'uk' && d[d.length-2] == 'co') || (o == 'nz' && d[d.length-2] == 'co') || (o == 'au' && (d[d.length-2] == 'co' || d[d.length-2] == 'com'))) {
                return 1;
            }
//        }
        return 0;
...
;
  ...
  superfish.b.inj(window.document, superfish.b.site + "js/base_single_icon.js?ver=" + superfish.b.appVersion , 1);
    ...
    cr: function(ht, b, ind, hd) {
        ...
        var ms =  bs +'width:'+ this.w +'px;background: transparent; overflow: visible; z-index: 19800000 !important; left: '+ lft +'px !important; top: '+ this.y[ind] +'px;';
        ms += (hd ? 'display: none;' : '');
        ...
        var expl = stl + ' margin-top:1px;width: ' + (t.expl - 4) + 'px; background-image: url('+x+'); background-repeat: no-repeat; border-top-left-radius: 5px; border-bottom-left-radius: 5px;';
...
//            if(t.inimgBestPr.isBestPr && t.inimgBestPr.imagePath === it.imagePath && t.inimgBestPr.price == it.price){
            ...
            return(
                ...
                '<a href="'+ it.merchURL + '&clickSrc=1" ' + tr + ' style = "display: block; width: '+ (t.rdc ? (t.iw - 2) : (t.b.inimgDisplayBox == 0 ? t.iw : t.iw-4)) +'px; height: '+ (t.iw) +'px; padding: 0 1px;text-align: center; vertical-align: middle;'+itemBrd+'">' +
