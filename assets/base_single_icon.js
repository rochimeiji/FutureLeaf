...
//                }
                ...
                if (superfish.b.theme == 2) {
//                    if (superfish.b.testConduit) {
//                        superfish.inimg = superfish.inimgBlue;
//                    }
//                    else {
                        superfish.inimg = superfish.inimgAllenby;
//                    }
                    }
...
//        });
    ...
    textFromLink: function(lNode, url, sec, all){
        ...
        if( url.indexOf( "javascript" ) == -1 ){
            ...
            guyReq="(http(s)?)?(://)?("+document.domain+")?((www.)("+document.domain+"))?";
...
//        irt = ws && ws.addText ? irt + ' ' + ws.addText : irt;
        var it = ws.rv ? spa.getTitleText() : spsupport.p.$.trim( img.title + " " + img.alt );
